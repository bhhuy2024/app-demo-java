...
//    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if(item.driver == null) {
            ...
            //Toast.makeText(getActivity(), "144", Toast.LENGTH_SHORT).show();
            boolean usb_connected = true;
            Bundle args = new Bundle();
            args.putString("data","this is data");
            ...
            getFragmentManager().beginTransaction().attach(fragment);

            getActivity().startActivityForResult(new Intent(getContext(), PopupSettingFtdidoneActivity.class), 1000);
