...
public class SerialService extends Service implements SerialListener {
    ...
    public void onCreate() {
        Log.d("StartService","onCreate()_service");
        super.onCreate();
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d("StartService","onStartCommand()_service");
//        Toast.makeText(this, "received param : ", Toast.LENGTH_SHORT).show();
    ...
    public void write(byte[] data) throws IOException {
        if(!connected) {
            Log.d("serial service ", "write  not connect");

            throw new IOException("not connected");
        }
        Log.d("SocketService","Write Data");
